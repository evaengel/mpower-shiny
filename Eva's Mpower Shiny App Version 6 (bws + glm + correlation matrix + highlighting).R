...
models <- read.csv("C:\\Users\\eva\\Documents\\Mpower - Duke Project\\combined_glm.csv")
...
nhanes1 <- read.csv("C:\\Users\\eva\\Documents\\Mpower - Duke Project\\nhanes1.csv")
#remove X column from nhanes1
nhanes2 <- nhanes1[,c(2:10)]

#reads in csv for bws simulation results
modelsa <- read.csv("C:\\Users\\eva\\Documents\\Mpower - Duke Project\\combined_bws.csv")
#turns results into dataframe
