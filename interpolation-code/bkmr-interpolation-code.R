...
UrinaryBisphenolA2 <- cbind(rep("UrinaryBisphenolA", times = 491),UrinaryBisphenolA1[,c(2,3)])
...
#labels dataframe with chemical name
UrinaryBenzophenone32 <- cbind(rep("UrinaryBenzophenone3", times = 491),UrinaryBenzophenone31[,c(2,3)])
colnames(UrinaryBenzophenone32)[1] <- "Chemical"

#reads in csv
Methylparaben1 <- read.csv("bkmr-interpolation-results/Methylparaben_large.csv")
#labels dataframe with chemical name
Methylparaben2 <- cbind(rep("Methylparaben", times = 491),Methylparaben1[,c(2,3)])
...
#labels dataframe with chemical name
Propylparaben2 <- cbind(rep("Propylparaben", times = 491),Propylparaben1[,c(2,3)])
#names column with chemical name "Chemical"
...
#labels dataframe with chemical name
dichlorophenol252 <- cbind(rep("dichlorophenol25", times = 491),dichlorophenol251[,c(2,3)])
#names column with chemical name "Chemical"
...
#labels dataframe with chemical name
dichlorophenol242 <- cbind(rep("dichlorophenol24", times = 491),dichlorophenol241[,c(2,3)])
#names column with chemical name "Chemical"
...
#labels dataframe with chemical name
MBzP2 <- cbind(rep("MBzP", times = 491),MBzP1[,c(2,3)])
#names column with chemical name "Chemical"
...
#labels dataframe with chemical name
MEP2 <- cbind(rep("MEP", times = 491),MEP1[,c(2,3)])
#names column with chemical name "Chemical"
...
#labels dataframe with chemical name
MiBP2 <- cbind(rep("MiBP", times = 491),MiBP1[,c(2,3)])
#names column with chemical name "Chemical"
