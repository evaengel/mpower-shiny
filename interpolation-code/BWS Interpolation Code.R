#read in bws simulation results
modelsa <- read.csv("C:\\Users\\eva\\Documents\\Mpower - Duke Project\\dataz.csv")
...
write.csv(zdataframe,"bws-simulation-data.csv",row.names = TRUE)
